...
[x_center_foot1, y_center_foot1, z_center_foot1, x_foot1, y_foot1, z_foot1] = find_geometric_center(groups_for_feet,x,y,z, 1, 10);

display('find_geometric_center for second foot is running')
[x_center_foot2, y_center_foot2, z_center_foot2, x_foot2, y_foot2, z_foot2] = find_geometric_center(groups_for_feet,x,y,z, 2, 10);
...
[bhat1, xhat1, yhat1, zhat1] = spherical_harmonics(x_foot1n, y_foot1n, z_foot1n, 40);
...
[bhat2, xhat2, yhat2, zhat2] = spherical_harmonics(x_foot2n, y_foot2n, z_foot2n, 40);
