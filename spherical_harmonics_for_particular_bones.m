function [coordinates_of_spherical_harmonics_for_particular_bones, struct_coef_of_spherical_harmonics_for_particular_bones] = spherical_harmonics_for_particular_bones(struct_of_normalized_xyz_for_n_bones_in_foot, number_of_bones_in_foot)
...
for i=1:number_of_fields
        ...
        struct_coef_of_spherical_harmonics_for_particular_bones.(char(field_names(i))) = bhat ;
